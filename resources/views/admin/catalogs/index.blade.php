    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white p-4 md:p-6 rounded-[2rem] border border-gray-100 shadow-sm mb-6"
                ...
                <form method="GET" action="{{ route('catalogs.index') }}" class="flex flex-col gap-4">
                    ...
                    <div class="flex flex-col md:flex-row items-center gap-3 w-full">
                        ...
                        <div class="relative flex-1 w-full">
                            <input type="text" name="search" value="{{ request('search') }}"
                                placeholder="{{ __('Search catalog names...') }}"
                    ...
                    <tbody class="divide-y divide-gray-50 bg-white">
                        @forelse ($catalogs as $catalog)
                            <tr class="hover:bg-gray-50/50 transition-colors">
                                <td class="px-8 py-5">
                                    <span
                                        class="text-sm font-black text-gray-700 uppercase tracking-tight">{{ $catalog->name }}</span>
                                </td>
                                <td class="px-6 py-5 text-center">
                                    <span
                                        class="px-3 py-1 rounded-full text-[9px] font-black uppercase border shadow-sm
                                        {{ $catalog->status === 'active' ? 'bg-green-50 text-green-700 border-green-200' : 'bg-red-50 text-red-700 border-red-200' }}">
                                        {{ $catalog->status }}
                                    </span>
                                </td>
                                ...
                                <td colspan="100" class="px-8 py-20 text-center bg-white">
                                    <div class="flex flex-col items-center justify-center gap-4">
                                        ...
                                        <div class="flex flex-col items-center">
                                            <span
                                                class="text-[11px] font-black uppercase text-gray-400 tracking-[0.2em]">{{ __('No Catalogs Found') }}</span>
                                            <p class="mt-1 text-[9px] font-bold text-gray-300 uppercase italic">
                                                {{ __('Try adjusting your search criteria or create a new catalog.') }}
                                            </p>
                                        </div>
                                    </div>
                                </td>
